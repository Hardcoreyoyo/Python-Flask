...
import six
from flask import request, current_app, g, Blueprint, abort
...
class Limiter(object):
    ...
    def ipBlockState(self, response):
        self.__check_conditional_deductions(response)
        current_limit = getattr(g, 'view_rate_limit', None)
        from limits.strategies import RateLimiter as get_window_stats
        window_stats = get_window_stats(*current_limit)
        Num = window_stats[1]
        NumStr = str(Num)
        return NumStr
